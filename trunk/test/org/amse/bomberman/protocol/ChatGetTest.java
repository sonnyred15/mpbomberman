...
public class ChatGetTest {
    ...
    @Test
    public void chatGetTest() throws Exception {//TODO TEST NEED FIX IN CONTROLLER
//        ProtocolMessage<Integer, String> request = requestCreator.requestAddChatMessage("ololo");
...
//        assertEquals("Can`t get game info in 'Not Joined' state.", message);
    }
}
