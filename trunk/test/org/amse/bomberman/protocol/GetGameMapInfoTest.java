 ...
 */
public class GetGameMapInfoTest {
    ...
    @Test
    public void getGameMapInfoNotJoined() throws Exception {
        ProtocolMessage<Integer, String> request = requestCreator.requestGameMap();
        ...
        assertEquals("Can`t get game map info in 'Not Joined' state.", message);
    }
}
