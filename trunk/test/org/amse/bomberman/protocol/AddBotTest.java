...
public class AddBotTest {
    ...
    @Test
    public void addBotTest() throws Exception {
        ProtocolMessage<Integer, String> request = requestCreator.requestJoinBotIntoGame();
        ...
        assertEquals("Can`t add bot in 'Not Joined' state.", message);
    }
}
