...
public class CreatingGameJDialog extends JDialog {
    ...
    public CreatingGameJDialog(ServerInfoJFrame jframe, Controller controller){
...
//        if (!maps[0].equals("No maps on server was founded.")) {//TODO
//            mapBox = new JComboBox(maps);
//        }
        String[] maps = {"1.map","16.map"};
        mapBox = new JComboBox(maps);
...
//            try {
                ...
                parent.controller.requestCreateGame(parent.getGameName(),mapName,parent.getMaxPlayers());
