...
public class LeaveTest {
    ...
    @Test
    public void leaveNotJoinedTest() throws Exception {
        ProtocolMessage<Integer, String> request = requestCreator.requestLeaveGame();
        ...
        assertEquals("Can`t leave in 'Not Joined' state.", message);
    }
}
