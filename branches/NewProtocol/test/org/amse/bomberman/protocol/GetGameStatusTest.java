...
public class GetGameStatusTest {
    ...
    @Test
    public void getGameStatusTest() throws Exception {
        ProtocolMessage<Integer, String> request = requestCreator.requestIsGameStarted();
        ...
        assertEquals("Can`t get game status in 'Not Joined' state.", message);
    }
}
